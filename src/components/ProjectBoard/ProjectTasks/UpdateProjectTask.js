                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            <h1 className="display-4 font-weight-bold text-center">Update a project Task</h1>
                            <p className="lead text-center">Project: {this.state.projectIdentifier} -- {this.state.projectSequence} </p>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <Link to= {`/projectBoard/${this.state.projectIdentifier}`}>
                                    <input type="submit" className="btn btn-secondary btn-block mt-4" value="Back"/>
                                </Link>
                            </form>
                        </div>
                    </div>
